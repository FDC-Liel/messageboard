...
class DATABASE_CONFIG {
	...
	public $default = array(
		...
		'prefix' => '',
		'unix_socket' => '/Applications/XAMPP/xamppfiles/var/mysql/mysql.sock' //add this line if encounter with this error "Error: Database connection "Mysql" is missing, or could not be created."
		//'encoding' => 'utf8',
  	);
